...
def test_DiscreteProblem_assign_dofs2():
    n1 = Node(1)
    n2 = Node(3)
    n3 = Node(4)
    n4 = Node(5)
    ...
    d = DiscreteProblem(meshes=[m1, m2])
    ndofs = d.assign_dofs(elem_l=1, elem_r=2, left_lift=True,
            left_values=[3, 5])

    assert m1.elements[1].dofs[0] == -1
    assert m1.elements[1].get_dirichlet_value(0) == 3
    assert m1.elements[1].dofs[1] == 0

    assert m1.elements[2].dofs[0] == 0
    assert m1.elements[2].dofs[1] == -1
    assert m1.elements[2].dofs[2] == 1

    assert m2.elements[1].dofs[0] == -1
    assert m2.elements[1].get_dirichlet_value(0) == 5
    assert m2.elements[1].dofs[1] == 0 + 2

    assert m2.elements[2].dofs[0] == 0 + 2
    assert m2.elements[2].dofs[1] == 1 + 2
    assert m2.elements[2].dofs[2] == 2 + 2
